...
import MoreBtnDesktop from "./MoreBtnDesktop";
...
const MoreBtn:React.FC = () => {
    ...
    const moreSectionOpen = (e: React.MouseEvent) => {
        setShowBtn(true);
        e.stopPropagation();
    }

    const moreSectionClose = (e: React.MouseEvent) => {
        setShowBtn(false);
        e.stopPropagation();
    }
    ...
    useEffect(() => {
        const moreSectionMobile = document.querySelector(".more-section-mobile") as HTMLElement;
        const moreSectionDesktop = document.querySelector(".more-section-desktop") as HTMLElement;

        if (showBtn) {
            (moreSectionMobile as HTMLElement).style.transform = "translateY(0%)";
            document.documentElement.style.overflowY = "hidden";
            // *************************************************************************
            (moreSectionDesktop as HTMLElement).style.opacity = "1";
            (moreSectionDesktop as HTMLElement).style.visibility = "visible";
            (document.querySelector(".more-btn-shadow") as HTMLElement).classList.add("more-btn-shadow--active");
        } else {
            (moreSectionMobile as HTMLElement).style.transform = "translateY(100%)";
            document.documentElement.style.overflowY = "auto";
            // *************************************************************************
            (moreSectionDesktop as HTMLElement).style.opacity = "0";
            (moreSectionDesktop as HTMLElement).style.visibility = "hidden";
            (document.querySelector(".more-btn-shadow") as HTMLElement).classList.remove("more-btn-shadow--active");
        }


        const handleClickOutside = (e: MouseEvent) => {
            e.stopPropagation();
            if ((showBtn) && (!moreSectionDesktop.contains((e.target) as HTMLElement)) && (!moreSectionMobile.contains((e.target) as HTMLElement))) {
                setShowBtn(false);
            }
        };
    ...
    return (
        <>
            ...
            <section className="more-section-mobile p-4 lg:hidden">
            ...
            <MoreBtnDesktop moreSectionClose={moreSectionClose} />
            <div className="more-btn-shadow"></div>
        </>
    );
}
